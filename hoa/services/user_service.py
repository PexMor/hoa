...
class UserService:
    ...
    def toggle_enabled(self, user_id: UUID, enabled: bool) -> User | None:
        """
    ...
    def disable(self, user_id: UUID) -> User | None:
        """
        Disable a user.
    ...
    def enable(self, user_id: UUID) -> User | None:
        """
        Enable a user.
    ...
    def make_admin(self, user_id: UUID) -> User | None:
        """
        Make user an admin.
    ...
    def remove_admin(self, user_id: UUID) -> User | None:
        """
