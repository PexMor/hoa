...
class AuthMethod(Base):
    ...
    identifier: Mapped[Optional[str]] = mapped_column(String(320), nullable=True, index=True)
...
class PasskeyAuth(AuthMethod):
    ...
    credential_id: Mapped[Optional[str]] = mapped_column(String(1024), nullable=True, unique=True, index=True)
    ...
    sign_count: Mapped[Optional[int]] = mapped_column(Integer, default=0, nullable=True)
    
    # Transport methods (usb, nfc, ble, internal)
    transports: Mapped[Optional[str]] = mapped_column(String(200), nullable=True)
    
    # Relying Party ID
    rp_id: Mapped[Optional[str]] = mapped_column(String(255), nullable=True, index=True)
...
class TokenAuth(AuthMethod):
    ...
    token_hash: Mapped[Optional[str]] = mapped_column(String(255), nullable=True, unique=True, index=True)
